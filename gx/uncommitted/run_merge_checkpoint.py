...
Usage:
- Run this file: `python great_expectations/uncommitted/run_merge_checkpoint.py`.
...
data_context: FileDataContext = get_context(
    context_root_dir="C:\Users\ID\Desktop\FAKULTET\1 LETNIK MAG\2semestar\IIR\gold-price-prediction\gx"
)
